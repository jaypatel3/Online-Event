		...
		<div class="ten columns">
			<nav id="navMain">
				<ul id="nav">
					...
					<li><a href="<%=request.getContextPath()%>/hotelController?flag=hotel">Hotels</a>
							<ul>
								<li><a
					...
					<ul>
						<c:forEach items="${sessionScope.lscategorysearch1234}" var="row">
                            <li><a href="<%=request.getContextPath()%>/foodsubcatController?id=${row.foodcatid}&flag=foodsubcat">${row.foodcatName}</a></li>
                            </c:forEach>
                        </ul>
...
<div class="container">
		...
		<div class="sixteen columns">
			...
			<div id="filters">
			<c:forEach items="${sessionScope.foodsubcat}" var="row">
				<ul class="option-set" data-option-key="filter">
				<li><a href="#" onclick="fnloadimage(${row.foodsbubcatid})" data-option-value=".photography">${row.foodsubcatname}</a></li>
