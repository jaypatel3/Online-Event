...
<div class="container" >
		...
		<form action="<%=request.getContextPath()%>/SignupController" method="post"  id="form" name="form">
		<center>
		<table class="formWrap">
            <!-- <tr  >
              <td > <label style="margin-right: 30px" >FIRST NAME::</label></td>
              <td> <input    type="text"  name="firstname"  class="placeholderField text"  required/></td>
           </tr>
            <tr>
               <td><label style="margin-right: 30px" > MIDDLE NAME::</label></td>
               <td><input class="placeholderField text" title="Middle Name" type="text" name="middlename"/></td>
            </tr>
       <tr>
               <td><label style="margin-right: 30px" >LAST NAME::</label></td>
             <td> <input class="placeholderField text"  type="text" name="lastname" required /></td>
         </tr> -->
...
<!--            class="placeholderField text" -->
  ...
  this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"/></td>
         ...
         <!--  <tr>
               <td><label style="margin-right: 30px" >Password::</label></td>
             <td> <input class="placeholderField text" title="Password" type="password" name="password" /></td>
         </tr>
           <tr> 
                 <td><label style="margin-right: 30px" >ADDRESS:: </label></td>
                  <td> <textarea title="Message" name="address" style="height: 40px;width:300px "></textarea></td>
   				</tr>
   				<tr>
          <td> <label style="margin-right: 30px" > CITY::</label></td>
           <td>    <select style="width:300px" name="city">
           ...
           <tr>
            <td><label style="margin-right: 30px" > STATE::</label></td>
               <td> <select style="width:300px" name="state">
                        <option value='option1'>Option 1</option>
                        <option value='option2'>Option 2</option>
                        <option value='option3'>Option 3</option>
                </select></td>
