...
<link rel="apple-touch-icon" sizes="72x72"
	href="../uimages/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="114x114"
	href="../uimages/apple-touch-icon-114x114.png">
			...
			<div class="ten columns">
				<nav id="navMain">
					<ul id="nav">
						...
						<li><a
							href="<%=request.getContextPath()%>/CategoryController?flag=allusercat">Events</a>
							<ul>
								<c:forEach items="${sessionScope.lsusercategorysearch12345}"
									var="row">
									<li><a
										href="<%=request.getContextPath()%>/subcategoryController?id=${row.id}&flag=subcat1">${row.catName}</a></li>
								</c:forEach>
							</ul></li>
						...
						<li><a
							href="<%=request.getContextPath()%>/foodcategoryController?flag=allfoodcat">Food</a>
							<ul>
								<c:forEach items="${sessionScope.lsfoodcategorysearch1234}"
									var="row">
									<li><a href="">${row.foodcatName}</a></li>
								</c:forEach>
							</ul></li>
		...
		<section class="content">
			...
			<div class="container">
				...
				<div class="sixteen columns">
					...
					<div id="filters">
						<c:forEach items="${sessionScope.usersubcat}" var="row">
							<ul class="option-set" data-option-key="filter">
								<li><a href="#" onclick="fnloadimage(${row.subcatid})"
									data-option-value=".photography">${row.subcategoryname}</a></li>
...
${row.photoname}
			...
			<div class="container">
				<!-- Portfolio Content -->
				<div id="portfolioWrap" class="da-thumbs">
					...
					<article class="four columns portfolioList photography abstract">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio1.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Celebration Party</h3>
								<p>IN THIS PARTY OF CELEBRATION, THE WHOLE DECARATION AND
									ARRANGEMENTS ARE UNIQUE IN LESS EXPENSE..</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList photography abstract ">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio2.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Music Concert</h3>
								<p>IN THIS EVENT WE WILL ARRANGE A NEW BAND OR SINGER AND
									MANY MORE ACCORING TO YOUR REQUIREMENT AND BUDGET.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList stationery technology">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio3.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Birthday Party</h3>
								<p>IN THIS PARY,THEME IS BALLON.ALL ARRANGEMENT IS ARRANED
									AS BALLON THEME,IN WHICH DIFFERENT TYPE OF BALLONS ARE USED.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList packaging">
						<a class="thumbLink" href="singleevent.jsp_project.html" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio4.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Promotion Party</h3>
								<p>IN THIS PROMOTION PARTY,WE WILL PLAN ACCORING TO OUR
									CLIENTS SO THEY CAN ENJOY FULLY THEIR ACHIEVEMENTS.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList architecture">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio5.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">College Event</h3>
								<p>COLLEGE TIME BEST TIME OF STUDENT LIFE ,SO WE THINK THAT
									STUDENTS CAN CELEBRATE THEIR MOMENTS FULLY UNFORGOTABLY.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList abstract">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio6.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Reception</h3>
								<p>RECEPTION OF THE MARRIAGE IS MAIN FUNCTION , IN WHICH
									MILD DECORATION IS THEIR AND TASTY FOOD WILL BE ARRANGED.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList technology abstract">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio7.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Reception</h3>
								<p>IN THIS ROYAL RECEPTION,THE GRAND RECEPTION WILL BE
									ARRANGE,THE ROYAL HALL WILL ARRANGED AS WELL AS ROYAL FOOD.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList architecture">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio8.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Technical Event</h3>
								<p>MANY TECHNICAL EVENTS SUCH AS PROJECT PRESENTAION ETC AND
									NON TECHNICAL EVENTS WILL ARRANGE FOR FUN.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList photography">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio9.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Wedding</h3>
								<p>THE GRAND ARRANGEMENT AND DECORATION WILL BE ARRANGED,
									MOMENTS OF THIS EVENT WILL EXECUTE PROPERLY.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList photography abstract">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio10.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Wedding</h3>
								<p>IN DIAMAND WEDDING THEME , WHOLE VENUE DECORATED WITH RED
									N GOLDEN COLOR OF FLOWERS AND MANY THINGS,ETC..</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList stationery">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio11.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Birthday Party</h3>
								<p>BIRTHDAY PARTY WAS HELD IN HOME OF OUR CLIENT,WE ARRANGED
									MANY FUN GAMES, FOODS AND RETURN GIFTS.</p>
							</section>
						</a>
					</article>
					...
					<article class="four columns portfolioList photography">
						<a class="thumbLink" href="singleevent.jsp" title="">
							<section class="thumbImage">
								...
								<img src="../uimages/portfolio12.jpg" alt=""
									class="scale-with-grid" />
							</section>
							<section class="thumbText">
								<h3 class="sectionTitle">Wedding</h3>
								<p>WE CAN ALSO MANAGE WEDDING EVENT IN TEMPLE OR CHURCH,THE
									WHOLE TEMPLE OR CHURCH IS DECORATED.</p>
							</section>
						</a>
					</article>
