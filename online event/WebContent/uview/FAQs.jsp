...
<div class="container">
	...
	<!-- FAQs -->
        ...
        <p class="introtext">Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Sed posuere consectetur est at lobortis. Nulla vitae elit libero, a pharetra augue. </p>
    ...
    <div class="sidebar four columns offset-by-one">
        	<h3 class="sectionTitle">Email Support</h3>
			<p>Can't find the answer to your question? Feel free to <a href="contact.html">contact us</a>, we are always ready to assist you with anything you have in mind.</p>
            
            <h3 class="sectionTitle">Community Support</h3>
            <p>With the growing community, most of your questions should be easily answered via the forums</p>
      </div>
