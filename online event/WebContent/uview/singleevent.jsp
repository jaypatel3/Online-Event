...
<!-- Basic Page Needs
 ================================================== -->
<meta charset="utf-8">
<title>Seamless - Single Project</title>
...
<header>
	...
	<div class="container">
		...
		</div>		Main Navigation End --><jsp:include page="../uview/header.jsp"></jsp:include>
	</div>
...
<div class="container">
		...
		<div class="sixteen columns">
			<h3 class="sectionTitle">Business Cards</h3>

			<div class="portfolioNav">
				<a href="singleeventwide.jsp" class="next"></a>
		...
		<div class="four columns">
				...
				<p>Nulla vitae elit libero, a pharetra augue. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget.</p>
				<p>Donec ullamcorper nulla non metus auctor fringilla. Donec ullamcorper nulla non metus auctor fringilla. Integer posuere erat a ante venenatis dapibus posuere velit aliquet.</p>
	...
	<div class="container">
		...
		<!-- Portfolio Content -->
			...
			<article class="four columns portfolioList stationery packaging">
            	<a class="thumbLink" href="single_project.html" title="" >
