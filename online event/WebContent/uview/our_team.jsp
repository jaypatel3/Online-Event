...
<div class="container">
        ...
        <div class="nine columns">
            <p class="introtext"><span>Award winning</span> digital agency with a depth to match. We can look after your <span>every need</span> and have all the corners covered. This is why our clients love us and why they keep <span>coming back.</span></p>
		</div>
        
        <div class="seven columns">
        
            <div id="teamAni" class="shadow hover">
                <div id="ta1"></div>
                <div id="ta2"></div>
                <div id="ta3"></div>
                <div id="ta4"></div>
                ...
                <div id="ta7"></div>
                <div id="ta8"></div>
                <div id="taMain"><h2>Seamless<br>Integration</h2></div>
            </div>
        ...
        <div class="four columns teamMember">
            <div class="teamMemberImage">
            	<img src="../uimages/avatar1.png" alt="" class="scale-with-grid"/>
            </div>
            <h3 class="sectionTitle">Joe Smith</h3> 
            <h4>Managing Director</h4>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
            
            <h3 class="sectionTitle">Skill Set</h3>
            <div class="teamSkill">
            	<ul>
					<li>
            ...
            <h3 class="sectionTitle">Say Hello</h3>
            <div class="teamSocial">
				<ul class="socialLinksTeam tooltips">
                    <li class="twitter"><a href="#" rel="tooltip" title="Twitter">Twitter</a></li>
                    <li class="facebook"><a href="#" rel="tooltip" title="Facebook">Facebook</a></li>
                    <li class="skype"><a href="#" rel="tooltip" title="Skype">Skype</a></li>
                    <li class="linkedin"><a href="#" rel="tooltip" title="LinkedIn">Linked In</a></li>
                    <li class="dropbox"><a href="#" rel="tooltip" title="Dropbox">Dropbox</a></li>
                </ul>
            </div>
        ...
        <div class="four columns teamMember">
            <div class="teamMemberImage">
            	<img src="../uimages/avatar3.png" alt="" class="scale-with-grid"/>
            </div>
            <h3 class="sectionTitle">John Smith</h3> 
            ...
            <div class="teamSkill">
            	<ul>
					...
					<li>
                        ...
                        <div class="bar percent55">
						<p class="percent">55%</p></div>
					</li>
					<li>
						<p class="skill">LinkedIn</p>
                        <div class="bar percent90">
						<p class="percent">90%</p></div>
					</li>
					<li>
						<p class="skill">Dirt Bike</p>
                        <div class="bar percent30">
						<p class="percent">30%</p></div>
					</li>
				</ul>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="four columns teamMember">
            <div class="teamMemberImage">
            	<img src="../uimages/avatar2.png" alt="" class="scale-with-grid"/>
            </div>
            <h3 class="sectionTitle">Paul Smith</h3> 
            ...
            <div class="teamSkill">
            	<ul>
					<li>
                        ...
                        <div class="bar percent95">
						<p class="percent">95%</p></div>
					</li>
					<li>
						<p class="skill">InDesign</p>
                        <div class="bar percent90">
						<p class="percent">90%</p></div>
					</li>
					<li>
					...
					<li>
						<p class="skill">New Stuff</p>
                        <div class="bar percent85">
						<p class="percent">85%</p></div>
					</li>
				</ul>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="four columns teamMember">
            <div class="teamMemberImage">
            	<img src="../uimages/avatar4.png" alt="" class="scale-with-grid"/>
            </div>
            <h3 class="sectionTitle">Peter Smith</h3> 
            <h4>Web Developer</h4>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
            ...
            <div class="teamSkill">
            	<ul>
					...
					<li>
						<p class="skill">Anti-Social</p>
                        <div class="bar percent70">
						<p class="percent">70%</p></div>
					</li>
					<li>
						<p class="skill">Xbox Live</p>
                        <div class="bar percent95">
						<p class="percent">95%</p></div>
					</li>
				</ul>
