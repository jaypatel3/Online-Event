...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
            ...
            <li class="current"><a href="messages.jsp"><span class="icon icon-message"></span>Messages</a></li>
    ...
    <div class="vernav iconmenu">
    	<ul>
        	<li class="current"><a href="manageblog.jsp" class="inbox">Inbox</a></li>
            <li><a href="newpost.jsp" class="drafts">Drafts</a></li>
