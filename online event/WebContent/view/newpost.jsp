...
<script type="text/javascript" src="../js/plugins/tinymce/jscripts/tiny_mce/jquery.tinymce.js"></script>
...
jQuery(document).ready(function(){
	...
	script_url : '../js/plugins/tinymce/jscripts/tiny_mce/tiny_mce.js',
...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
        	<li><a href="dashboard.jsp"><span class="icon icon-flatscreen"></span><span>Dashboard</span></a></li>
            <li class="current"><a href="manageblog.jsp"><span class="icon icon-pencil"></span>Manage Blog</a></li>
    ...
    <div class="vernav">
    	<ul>
        	<li><a href="manageblog.jsp">Posts</a></li>
            <li class="current"><a href="newpost.jsp">Create New Post</a></li>
